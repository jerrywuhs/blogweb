    ...
    <div className="space-y-6">
      <div className="rounded-3xl border border-white/10 bg-white/5 p-6">
        ...
        <div className="mt-4 grid gap-3 text-sm text-white/70">
          <label className="flex items-center justify-between rounded-2xl border border-white/10 bg-black/40 px-4 py-3">
            风险敏感度
            <span className="text-xs text-white/50">中等</span>
          </label>
          <label className="flex items-center justify-between rounded-2xl border border-white/10 bg-black/40 px-4 py-3">
            输出格式
            <span className="text-xs text-white/50">结构化摘要</span>
          </label>
        </div>
      </div>
      ...
      <div className="rounded-3xl border border-white/10 bg-white/5 p-6">
        ...
        <textarea
          ...
          className="mt-4 min-h-[140px] w-full rounded-2xl border border-white/10 bg-black/40 px-4 py-3 text-sm text-white"
        />
        <button
          onClick={run}
      ...
      <div className="rounded-3xl border border-white/10 bg-white/5 p-6">
        ...
        <div className="mt-4 rounded-2xl border border-white/10 bg-black/40 p-4 text-xs text-emerald-200">

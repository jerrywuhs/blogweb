      ...
      <main className="mx-auto w-full max-w-6xl px-6 pb-20 pt-12">
        ...
        <section className="mt-10 grid gap-8 lg:grid-cols-[1fr_320px]">
          <article className="space-y-8 text-[17px] leading-relaxed text-muted">
            ...
            <div className="rounded-3xl border border-[color:var(--border-muted)] bg-[color:var(--surface-1)] p-8">
              <h2 className="text-2xl font-semibold text-white">核心框架示意</h2>
              <p className="mt-4">
                以“数据采集 → 指标计算 → 策略决策 → 执行回测/实盘”为主链路，
                确保每一层都有清晰的输入输出标准。
              </p>
              <pre className="mt-5 overflow-x-auto rounded-2xl border border-[color:var(--border-muted)] bg-black/70 p-5 text-sm text-emerald-200">
{`def pipeline(data):
